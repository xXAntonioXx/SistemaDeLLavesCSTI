    ...
    <div class="inventory">
      ...
      <div class="inventory-items">
        <div v-for="objeto in objetos" :key="objeto['id']" class="inventory-item">
          ...
          <h4 id="inventory-item-description" :key="'inventory-item-description-'+objeto['id']" @click="openObjectEdit(objeto['id'],objeto['nombre'],objeto['marca'],objeto['descripcion'],objeto['inventario'])">{{(objeto['descripcion'] && objeto['descripcion'].length >35) ? (objeto['descripcion'].substring(0,35)+'...') :objeto['descripcion'] }}</h4>
